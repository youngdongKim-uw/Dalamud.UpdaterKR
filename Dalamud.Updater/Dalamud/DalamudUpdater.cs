...
namespace XIVLauncher.Common.Dalamud
{
    ...
    public class DalamudUpdater
    {
        ...
        public const string ASSET_VER = "160";
        public const string GH_BASE = "https://raw.githubusercontent.com/dohwacorp/DalamudResource/main/";
        public const string ASSET_DL_PATH = GH_BASE + "dalamudAssets.zip";
        public const string REMOTE_VERSION = GH_BASE + "VersionInfo?track";
        public const string REMOTE_DOTNET = GH_BASE + "dotnet-runtime-7.0.0-win-x64.zip";
        public const string REMOTE_DESKTOP = GH_BASE + "windowsdesktop-runtime-7.0.0-win-x64.zip";
        ...
        private async Task UpdateDalamud()
        {
            ...
            if (remoteVersionInfo.RuntimeRequired || settings.DoDalamudRuntime)
            {
                ...
                await DownloadAsset(this.assetDirectory, ASSET_VER).ConfigureAwait(false);
            }
            ...
            //    return;
            //}
            // [[ No idea why they annotate here ]] //
        ...
        private async Task DownloadRuntime(DirectoryInfo runtimePath, string version)
        {
            ...
            var dotnetUrl = REMOTE_DOTNET;
            var desktopUrl = REMOTE_DESKTOP;
        ...
        private async Task DownloadAsset(DirectoryInfo assetPath, string version)
        {
            if (Directory.Exists($"{assetPath.FullName}/{version}/UIRes") && File.Exists($"{assetPath.FullName}/{version}/UIRes/NotoSansKR-Regular.otf")) return;
            ...
            await DownloadFile(ASSET_DL_PATH, downloadPath).ConfigureAwait(false);
            ...
            {
                var completeFileName = Path.Combine(destinationDirectoryFullPath, file.FullName);
